    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-zinc-700 max-w-[300px]">
        ...
        <div class="pt-6">
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            ...
            <a href="{{ route('products.view', ['id' => $product->product_id]) }}" class="inline-flex items-center rounded-lg bg-blue-700 px-6 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4  focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Ver detalles
            <svg class="hover:translate-x-2 duration-300 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
